...
class WbZalando extends Module{
    ...
    public function install(){
        ...
        return (
            parent::install() &&
            $this->instalarTabs() && 
            $this->crearTablas($this->tablaModulo) && 
            $this->registerHook("displayBackOfficeHeader") && 
            $this->crearVariablesDeConfiguracion());
    }
    ...
    public function uninstall(){
        ...
        return (
            parent::uninstall() &&
            $this->desintalarTabs() && 
            $this->eliminarTablas($this->tablaModulo) &&
            $this->unregisterHook("displayBackOfficeHeader") && 
            $this->eliminarVariablesDeConfiguracion());
    }

    public function crearVariablesDeConfiguracion(){
        return (
    ...
    public function eliminarVariablesDeConfiguracion (){
        return (
    ...
    public function instalarTabs(){
        $tagSubMenu=$this->getTabSubMenu();
    ...
    public function desintalarTabs(){
        $estado=true;
    ...
    public function crearTablas($prefijoTabla){
        $tablas=[
    ...
    public function eliminarTablas($prefijoTabla){
        $tablas=[
